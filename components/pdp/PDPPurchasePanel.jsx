    ...
    <div id="purchase-panel" className="flex flex-col text-left w-full h-full pb-8 lg:pb-24">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3 text-sm mb-4">
          ...
          <span onClick={() => document.getElementById('reviews')?.scrollIntoView({ behavior: 'smooth' })} className="text-secondary-text font-medium underline cursor-pointer hover:text-primary-text transition-colors">248 Reviews</span>
        </div>
