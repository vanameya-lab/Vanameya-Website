      ...
      <div className="max-w-container-max mx-auto relative">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-6 flex flex-col text-left">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                >
                  ...
                  <span className="text-[10px] font-normal tracking-wide text-on-surface-variant/70 uppercase">15 Sachets</span>
                </button>
                ...
                >
                  <span className="absolute -top-2 left-1/2 -translate-x-1/2 px-2.5 py-0.5 bg-warm-gold rounded-full text-white text-[8px] font-bold uppercase tracking-wider shadow-sm">
                    Best Value
                  </span>
                  <span className="block text-lg font-display">3 Boxes</span>
                  <span className="text-[10px] font-normal tracking-wide text-on-surface-variant/70 uppercase">45 Sachets</span>
                </button>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-earth-brown/10 text-[10px] text-on-surface-variant/65 flex flex-col gap-2">
              <div className="flex items-center gap-2">
                <svg className="w-3.5 h-3.5 text-warm-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
