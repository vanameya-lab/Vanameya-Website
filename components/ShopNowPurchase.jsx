        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-6 w-full flex flex-col justify-start">
            <motion.div
              ...
              className="w-full aspect-[4/3] relative rounded-3xl overflow-hidden shadow-xl bg-gradient-to-br from-white to-[#fdfbf7] border border-earth-brown/10 flex items-center justify-center p-6"
            >
              <Image
            ...
            <div className="mt-6 text-center lg:text-left">
              <p className="text-xs text-on-surface-variant/75 font-light tracking-wide flex items-center justify-center lg:justify-start gap-2">
          ...
          <div className="lg:col-span-6 flex flex-col text-left">
            ...
            <div className="flex flex-wrap items-baseline gap-4 mb-8">
              ...
              <span className="text-xl text-on-surface-variant/60 font-light line-through decoration-1">
                ₹{getOriginalPrice()}
              </span>
              
              <div className="flex flex-wrap gap-2 items-center">
                <span className="px-2.5 py-1 bg-primary/5 border border-primary/20 rounded text-primary font-semibold text-[10px] uppercase tracking-wider">
                  Initial Offer
                </span>
                {purchaseType === "subscribe" && (
                  <span className="px-2.5 py-1 bg-warm-gold/20 border border-warm-gold/30 rounded text-warm-gold font-semibold text-[10px] uppercase tracking-wider">
                    Save 15%
                  </span>
                )}
                {packSize === 2 && (
            ...
            <div className="flex flex-col gap-4 mb-8">
              ...
              >
                ...
                <span className="font-semibold text-primary">₹{getPrice("one-time", packSize, 1)}</span>
              </div>
              ...
              >
                ...
                <span className="font-semibold text-primary">₹{getPrice("subscribe", packSize, 1)}</span>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                <button
                  ...
                  className={`p-4 border-2 rounded-xl text-center transition-all duration-300 font-semibold cursor-pointer ${
                    packSize === 1 
                      ...
                      : "border-earth-brown/15 bg-white text-on-surface-variant hover:border-primary/20"
                  }`}
                >
                  <span className="block text-lg font-display">1 Box</span>
                  <span className="text-[10px] font-normal tracking-wide text-on-surface-variant/70 uppercase">10 Sachets</span>
                </button>
                ...
                >
                  <span className="absolute -top-2 left-1/2 -translate-x-1/2 px-2.5 py-0.5 bg-green-600/90 rounded-full text-white text-[8px] font-bold uppercase tracking-wider shadow-sm whitespace-nowrap">
                    Save 5%
                  </span>
                  <span className="block text-lg font-display">2 Boxes</span>
                  <span className="text-[10px] font-normal tracking-wide text-on-surface-variant/70 uppercase">20 Sachets</span>
                </button>
                ...
                >
                  <span className="absolute -top-2 left-1/2 -translate-x-1/2 px-2.5 py-0.5 bg-[#d9232d] rounded-full text-white text-[8px] font-bold uppercase tracking-wider shadow-sm whitespace-nowrap">
                    Save 7% + Free Shipping
                  </span>
                  <span className="block text-lg font-display">3 Boxes</span>
                  <span className="text-[10px] font-normal tracking-wide text-on-surface-variant/70 uppercase">30 Sachets</span>
                </button>
              </div>
            </div>

            {/* Quantity Selector */}
            <div className="flex items-center justify-between border-t border-earth-brown/10 pt-8 mb-10">
              <span className="text-[10px] text-warm-gold font-bold uppercase tracking-wider">Quantity</span>
              <div className="flex items-center border border-earth-brown/20 rounded-xl overflow-hidden bg-white">
                <button 
                  onClick={() => setQuantity(Math.max(1, quantity - 1))}
                  className="px-4 py-2 hover:bg-surface-dim/30 font-semibold text-primary transition-colors cursor-pointer"
                >
                  -
                </button>
                <span className="px-6 py-2 text-primary font-display font-semibold border-x border-earth-brown/15">
                  {quantity}
                </span>
                <button 
            ...
            <div className="flex flex-col gap-4">
              <button
                ...
                disabled={loading}
                className="w-full py-4 bg-primary text-white text-label-caps rounded-xl hover:bg-primary-container disabled:opacity-75 transition-all duration-300 shadow-md text-center flex items-center justify-center gap-2 cursor-pointer font-semibold"
              >
                {loading ? (
                  <>
              ...
              <a
                ...
                className="w-full py-4 border-2 border-[#25D366] text-[#25D366] hover:bg-[#25D366]/5 text-label-caps rounded-xl transition-all duration-300 text-center flex items-center justify-center gap-2 font-semibold"
              >
            ...
            <div className="mt-8 pt-6 border-t border-earth-brown/10 text-[10px] text-on-surface-variant/65 flex flex-col gap-4">
              <div className="flex items-start gap-2">
                <svg className="w-4 h-4 text-warm-gold shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
                </svg>
                <div className="flex flex-col gap-1">
                  <span className="font-semibold text-on-surface-variant/80 uppercase tracking-wider text-[9px]">Shipping Terms & Conditions</span>
              ...
              <div className="flex items-center gap-2">
                <svg className="w-3.5 h-3.5 text-warm-gold shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
